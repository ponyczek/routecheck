 ...
 */
export function AssignmentsHeader({ onAddClick }: AssignmentsHeaderProps) {
  return (
    <div className="flex items-center justify-between">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Przypisania kierowca-pojazd</h1>
        <p className="text-muted-foreground mt-1">Zarządzaj harmonogramem przypisań kierowców do pojazdów</p>
      </div>
