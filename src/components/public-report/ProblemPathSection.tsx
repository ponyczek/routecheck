 ...
 * )}
 */
export function ProblemPathSection({ 
  register, 
  errors, 
  watch,
  onFieldFocus 
}: ProblemPathSectionProps) {
  return (
    <div className="space-y-8 py-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-900">
          <strong>Wskazówka:</strong> Jeśli trasa została częściowo wykonana, 
          opisz przyczynę w powodzie opóźnienia lub w problemach na jutro.
        </p>
      </div>
    </div>
  );
