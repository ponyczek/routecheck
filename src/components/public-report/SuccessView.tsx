 ...
 * />
 */
export function SuccessView({ reportUuid, editableUntil, onEdit, isProcessingQueue }: SuccessViewProps) {
    ...
    <div className="max-w-2xl mx-auto p-6">
      <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6">
        ...
        {!isOfflinePending && canEdit && (
          <Button onClick={onEdit} size="lg" variant="outline" className="font-semibold">
          ...
          <div className="w-full max-w-md mt-8 p-6 bg-blue-50 border border-blue-200 rounded-lg">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-blue-900 mb-1">Przetwarzanie raportu</p>
        ...
        {!isOfflinePending && (
          <div className="text-xs text-gray-500 mt-8">
            <p>
              ID raportu: <code className="font-mono">{reportUuid}</code>
            </p>
          </div>
        )}
      </div>
