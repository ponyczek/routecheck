      ...
      <CardContent className="space-y-6">
          ...
          <div className="flex items-start gap-3 p-3 rounded-lg bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-blue-800 dark:text-blue-200 leading-relaxed">
                Wszystkie logowania, wylogowania i istotne działania w systemie są 
                rejestrowane w logach audytowych firmy <strong>{companyName}</strong>. 
                Dzięki temu administrator może monitorować bezpieczeństwo kont 
        ...
        <div className="pt-2">
          <p className="text-xs text-muted-foreground">
            W przypadku podejrzenia naruszenia bezpieczeństwa konta, 
            natychmiast skontaktuj się z administratorem systemu.
          </p>
        </div>
      </CardContent>
    </Card>
