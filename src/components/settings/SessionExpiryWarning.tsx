...
export function SessionExpiryWarning({ expiresAt, remainingHours }: SessionExpiryWarningProps) {
  ...
  return (
    <Alert className="border-amber-500/50 bg-amber-50 dark:bg-amber-950/20">
      ...
      <AlertTitle className="text-amber-900 dark:text-amber-100">Automatyczne wygaśnięcie sesji</AlertTitle>
      <AlertDescription className="text-amber-800 dark:text-amber-200">
        ...
        <div className="mt-1 text-sm">Data wygaśnięcia: {formattedDate}</div>
      </AlertDescription>
    </Alert>
  );
}
