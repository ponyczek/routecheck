...
export function EmptyState({ hasFilters, onAddClick }: EmptyStateProps) {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <p className="mb-6 max-w-sm text-sm text-gray-600 dark:text-gray-400">
          Nie masz jeszcze żadnych pojazdów w systemie. Dodaj pierwszy pojazd, aby móc zarządzać
          flotą.
        </p>
        {onAddClick && (
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 text-center">
      ...
      <p className="mb-6 max-w-sm text-sm text-gray-600 dark:text-gray-400">
        Nie znaleziono pojazdów spełniających wybrane kryteria. Spróbuj zmienić filtry lub
        wyszukiwane frazy.
      </p>
    </div>
  );
